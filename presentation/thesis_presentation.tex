    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            ...
            \begin{tikzpicture}[scale=0.8]
                ...
                % 80% = 288 degrees, 20% = 72 degrees
                \filldraw[ulblue!70] (0,0) -- (0,2) arc (90:-198:2) -- cycle;
                \filldraw[gray!30] (0,0) -- (0,2) arc (90:162:2) -- cycle;
                \draw[thick] (0,0) circle (2);
                
                \node at (0.8,-0.8) {\footnotesize 80\%};
                \node at (-0.7,0.7) {\footnotesize 20\%};
                \node at (-1.2,1.2) {\tiny Structured};
                \node at (0.8,-1.2) {\tiny Unstructured};
...
\begin{frame}{From Text to Knowledge}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            ...
            \draw[->, thick, ulblue] (2.2,0) -- (4.8,0);
            \node at (3.5,0.8) {\footnotesize \textbf{Our Pipeline}};
...
\begin{frame}{Why Knowledge Graphs for Biomedicine?}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \vspace{1cm}
            \begin{tikzpicture}[scale=0.8]
                \node[circle, draw, fill=nercolor!30, minimum size=1.2cm] (drug) at (0,3) {\footnotesize Drug};
                \node[circle, draw, fill=linkcolor!30, minimum size=1.2cm] (disease) at (3.5,0) {\footnotesize Disease};
                \node[circle, draw, fill=relcolor!30, minimum size=1.2cm] (gene) at (0,0) {\footnotesize Gene};
                \node[circle, draw, fill=graphcolor!30, minimum size=1.2cm] (pathway) at (-3.5,1) {\footnotesize Pathway};
...
\begin{frame}{System Architecture Overview}
    ...
    \begin{center}
        \begin{tikzpicture}[
            ...
            \node[block, left of=relation, fill=ulgreen!30] (cypher) {Cypher Query\\Generation};
            \node[block, left of=cypher, fill=graphcolor!30] (graph) {Knowledge Graph\\(Neo4j)};

            \draw[arrow] (data) -- (ner);
            \draw[arrow] (ner) -- (linking);
            \draw[arrow] (linking) -- (relation);
            \draw[arrow] (relation) -- (cypher);
            \draw[arrow] (cypher) -- (graph);
        \end{tikzpicture}
    \end{center}
...
\begin{frame}[plain]
    \begin{center}
        ...
        \begin{tikzpicture}
            \node at (0,0) {\includegraphics[height=1.2cm]{assets/UL.png}};
            \node at (5,0) {\includegraphics[height=1.2cm]{assets/IDMC.png}};
        \end{tikzpicture}
