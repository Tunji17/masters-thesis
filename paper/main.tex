...
\thesistitle{Transforming Unstructured Clinical Text into Actionable Knowledge Graphs: A Multi-Model Approach for Healthcare Information Extraction} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Maziyar \textsc{PANAHI}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{Vincent \textsc{Colotte}} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
...
\href{https://idmc.univ-lorraine.fr}{\examname} % Examiner name
\end{flushright}
\end{minipage}\\[3cm]
...
TO:DO - The Thesis Abstract is written here (and usually kept to just this page). The page is kept centered vertically so can expand into the blank space above the title too\ldots
\end{abstract}
...
\include{Chapters/Chapter2} % Literature Review and Theoretical Background
\include{Chapters/Chapter3} % Methodology and System Architecture
\include{Chapters/Chapter4} % Comparative Analysis: MedGemma vs Gemma Models
\include{Chapters/Chapter5} % Experimental Setup and Implementation
\include{Chapters/Chapter6} % Results and Evaluation
\include{Chapters/Chapter7} % Discussion
\include{Chapters/Chapter8} % Conclusions and Future Work
